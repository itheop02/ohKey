            ...
            <div class="about-heading-content">
                ...
                <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                    <h2 class="section-heading mb-4">
                        ...
                        <br>
                        <h4>Select one e-commerce platform</h4>
                        <br>
                    </h2>
                        ...
                        <div class="row gx-4 gx-lg-5" style="justify-content: center;">
                            ...
                            <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                                <form action="https://child-project.eu/policy/loadPolicy.php" method="post" >
                                    ...
                                    <input style="display: none;" type="text" id="policyID" name="policyID" value="4">
                            ...
                            <div class="col-lg-3 col-md-6 mb-5 mb-md-0">
                                <form action="https://child-project.eu/policy/loadPolicy.php" method="post" >
                                    ...
                                    <label style="display: none;"  for="policyID"> </label>
                                    <input style="display: none;" type="text" id="policyID" name="policyID" value="5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <form action="https://child-project.eu/policy/loadPolicy.php" method="post" >
                                    ...
                                    <label style="display: none;"  for="policyID"> </label>
                                    <input style="display: none;" type="text" id="policyID" name="policyID" value="6">
