...
<!--                            <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="survey.html">Survey</a></li>-->
                ...
                <div class="about-heading-content">
                    ...
                    <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                        <h2 class="section-heading mb-4">
                            ...
                            <h3>Select the type of platform of which you will annotate the policy</h3>
                            <br>
                        </h2>
                        <div class="container px-4 px-lg-5 text-center">
                            <div class="row gx-4 gx-lg-5" style="justify-content: center;">
                                ...
                                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                                    <form action="https://child-project.eu/policy/social-media-platforms.php" method="post" >
                                        ...
                                        <button type="submit" style="background: none; border:none;">
                                            <span class="service-icon-social-media rounded-circle mx-auto mb-3"><i class="fa fa-globe"></i></span>
                                            <h4><strong>Social  Media Platforms </strong></h4>
                                        </button>
                                    </form>
                                </div>

                                <!-- E-COMMERSE PLATFORMS -->
                                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                                    <form action="https://child-project.eu/policy/e-commerce-platforms.php" method="post" >
                                        ...
                                        <button type="submit" style="background: none; border:none;">
                                            <span class="service-icon-e-commerce rounded-circle mx-auto mb-3"><i class="fa fa-shopping-bag"></i></span>
                                ...
                                <!-- ONLINE APP STORE PLATFORM BUTTON ---------------------------------------------------- -->
                                <div class="col-lg-3 col-md-6 mb-5 mb-md-0" style="display: none;">
                                    <form action="https://child-project.eu/policy/online-app-stores.php" method="post" >
                                        ...
                                        <button type="submit" style="background: none; border:none;">
                                            ...
                                            <h4><strong>Online app Stores </strong></h4>
                                        </button>
                                ...
                                <!--ONLINE ADVERTISING BUTTON ---------------------------------------------------- -->
                                <div class="col-lg-3 col-md-6">

                                    <form action="https://child-project.eu/policy/online-advertising.php" method="post">

                                        <label style="display: none;"  for="displayAge4"> </label>
                                        <input style="display: none;" type="text" id="displayAge4" name="displayAge4">

                                        <label style="display: none;"  for="displayGender4"> </label>
                                        <input style="display: none;" type="text" id="displayGender4" name="displayGender4">

                                        <label style="display: none;"  for="displayLaw4"> </label>
                                        <input style="display: none;" type="text" id="displayLaw4" name="displayLaw4">


                                        <button type="submit" style="background: none; border:none;" >

                                                <span class="service-icon rounded-circle mx-auto mb-3"><i class="fa fa-shopping-basket"></i></span>
        ...
        <script>
            window.onload = function () {
                ...
                document.getElementById("displayAge4").value = age;
                document.getElementById("displayGender4").value = gender;
                document.getElementById("displayLaw4").value = law;
